...
const screens = [
  ...
  { id:"c3", type:"component", number:"Component 3", section:"Engaging with Empathy", sectionColor:S2,
    ...
    points:[
      { label:"From the Community, For the Community", detail:"Our employees often come from the communities they serve, bringing authentic knowledge, community understanding, and genuine connection." },
  ...
  { id:"c8a", type:"component", number:"Component 8 – Part A", section:"Mutually Beneficial Relationships", sectionColor:S4,
    ...
    points:[
      ...
      { label:"Practice Success Plans", detail:"The Regional Network Executive and Regional Chief Medical Officer lead the development of Practice Success Plans in partnership with practice leadership. A focused set of goals is agreed upon — along with how they will be achieved. Practice Facilitators then work directly with the practice to implement the workflows needed to achieve those goals, serving as the day-to-day partners in turning the plan into action." },
    ],
